...
public class UVCCamera {
    // TODO set false when releasing
    private static final boolean DEBUG = false;
    private static final String TAG = UVCCamera.class.getSimpleName();
    private static final String DEFAULT_USBFS = "/dev/bus/usb";

    public static final int DEFAULT_PREVIEW_WIDTH = 384;
    public static final int DEFAULT_PREVIEW_HEIGHT = 292;
    ...
    public synchronized void open(UsbControlBlock ctrlBlock) {
        ...
        try {
            ...
            Log.e(TAG, result + ":" + mCtrlBlock.getVenderId() + ","
...
// 			   Log.d(TAG, "setZoom:zoom=" + zoom + " ,value=" + z);
    ...
    // nativeCreate 和 nativeDestroy 不是静态方法。
    private final native long nativeCreate();

    private final native void nativeDestroy(final long id_camera);

    private static final native int nativeIsCorrect(final long id_camera);
...
//**********************************************************************
    ...
    public int isCorrect() {
        ...
        if (mCtrlBlock != null) {
            Log.e(TAG, "IsCorrect");
            result = nativeIsCorrect(mNativePtr);
        }
        return result;
    }
